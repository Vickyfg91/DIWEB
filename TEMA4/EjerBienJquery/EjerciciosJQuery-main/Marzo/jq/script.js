...
*/ 
/*Mostrar y ocultar el menú principal con efecto de persiana*/
$(function(){
    var menuabierto =false;
    $('#hamburger').on('click',function(){
        if(!menuabierto){
            $('ul#menu-toggle').finish().slideDown('slow');
        /*La raya de enmedio crece*/
        $('.line-ham:nth-child(2)').stop(true, true).animate({
            'width':'65%'
        },400);
        ...
        },500);console.log("Esto es rojo?");
        /**Vuelve al estado original */
        } else {
            $('ul#menu-toggle').stop(true, true).slideUp('slow');
